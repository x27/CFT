...
namespace CFT
{
    public partial class P25AESEncryptionMethodForm : Form
    {
        public P25AESEncryptionRow EncryptionRow { get; private set; }
        public bool IsBatchMode { get; private set; }

        public P25AESEncryptionMethodForm(P25AESEncryptionRow row = null, bool batchMode = false)
        {
            InitializeComponent();
            ...
            if (row == null)
            {
                EncryptionRow = new P25AESEncryptionRow();
                EncryptionRow.Key = new byte[P25AESEncryptionRow.KEY_SIZE];
                if (!IsBatchMode)
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (key.Length > 0)
                Buffer.BlockCopy(key, 0, EncryptionRow.Key, 0, key.Length > P25AESEncryptionRow.KEY_SIZE ? P25AESEncryptionRow.KEY_SIZE : key.Length);
