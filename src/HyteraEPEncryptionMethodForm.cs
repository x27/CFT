...
namespace CFT
{
    public partial class HyteraEPEncryptionMethodForm : Form
    {
        public HyteraEPEncryptionRow EncryptionRow { get; private set; }
        public bool IsBatchMode { get; private set; }

        public HyteraEPEncryptionMethodForm(HyteraEPEncryptionRow row = null, bool batchMode = false)
        {
            InitializeComponent();
            ...
            if (row == null)
            {
                EncryptionRow = new HyteraEPEncryptionRow();
                EncryptionRow.Key = new byte[HyteraEPEncryptionRow.KEY_SIZE];
                if (!IsBatchMode)
