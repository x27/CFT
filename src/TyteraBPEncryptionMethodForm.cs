...
namespace CFT
{
    public partial class TyteraBPEncryptionMethodForm : Form
    {
        public TyteraBPEncryptionRow EncryptionRow { get; private set; }

        public bool IsBatchMode { get; private set; }

        public TyteraBPEncryptionMethodForm(TyteraBPEncryptionRow row = null, bool batchMode = false)
        {
            InitializeComponent();
            ...
            if (row == null)
            {
                EncryptionRow = new TyteraBPEncryptionRow();
                if (!IsBatchMode)
